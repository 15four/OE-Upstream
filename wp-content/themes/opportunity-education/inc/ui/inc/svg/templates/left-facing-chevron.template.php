...
/**
 * Template for left facing chevron SVGs
 *
...
// Set attributes
$attributes = array(
	'class' => 'c-svg c-svg--left-facing-chevron ' . $args['additional_classes']
);
...
<<?php echo $args['tag'] . ' ' . \fifteen_four\helpers\get_attributes_from_array( $attributes ); ?>>
	<div <?php echo \fifteen_four\helpers\get_attributes_from_array( $inner_attributes ); ?>>
		<svg <?php echo \fifteen_four\helpers\get_attributes_from_array( $svg_attributes ); ?>>
			<line <?php echo \fifteen_four\helpers\get_attributes_from_array( $line_attributes ); ?> x1="25" y1="50" x2="75" y2="10" />
			<line <?php echo \fifteen_four\helpers\get_attributes_from_array( $line_attributes ); ?> x1="25" y1="50" x2="75" y2="90" />
		</svg>
	</div>
</<?php echo $args['tag']; ?>>
