...
window.jQuery.psj.accessibility = {
	...
	focusFirstTabbableElement: function(container) {
		var tabbableElements = container.find(window.jQuery.psj.accessibility.tabbableElementSelectors.join(',')).filter(':visible').filter(window.jQuery.psj.helpers.isVisible);
